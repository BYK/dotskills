...
description: Use the Sentry CLI to find and fix the top issues affecting the most users from the latest release, opening one PR per issue and iterating until CI is green and review comments are addressed
---
