---
name: iterate-pr
description: Iterate on an open PR — fix failing CI jobs and address all unresolved review comments (from humans and bots like Sentry Seer / Cursor BugBot) until checks are green and threads are resolved
---
